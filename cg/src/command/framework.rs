...
/// All the From<T> for argument help implement default value conversion. they are, in no way, needed.
...
/*impl<T> Transform<Option<T>> for Argument
where Argument: Transform<T> {
    fn transform(&mut self, value: &Option<T>) {
        match  {
